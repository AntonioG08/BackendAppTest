...
class Compra(db.Model):
    ...
    """With this we are creating a relationship with the other model 'Usuario' to the class 'Usuario' to the atribute 
       'compras'. With this, we can inherit his methods too. """
